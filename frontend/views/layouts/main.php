...
use frontend\assets\MaterialAsset;          //อ้างอิงโฟรเดอร์
...
MaterialAsset::register($this);    //register ไฟล์ MaterialAsset
...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <div class="wrap">
            <?php
            NavBar::begin([
                'brandLabel' => 'ศูนย์ข้อมูลผู้ป่วย รพ.เชียงคาน',
            ...
            if (Yii::$app->user->isGuest) {
                $menuItems[] = ['label' => 'สมัครผู้ใช้งาน', 'url' => ['/site/signup']];
